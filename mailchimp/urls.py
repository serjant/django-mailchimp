...
from mailchimp.views import webhook, dequeue, cancel, test_real, mailchimp_overview, schedule_campaign_for_object, test_campaign_for_object, campaign_information

if StrictVersion(django.get_version()) > StrictVersion('1.7.0'):
    urlpatterns = [
        url(r'^$', VIEWS_OVERVIEW or mailchimp_overview, name='mailchimp_overview', kwargs={'page':'1'}),
        url(r'^(?P<page>\d+)/$', VIEWS_OVERVIEW or mailchimp_overview, name='mailchimp_overview'),
